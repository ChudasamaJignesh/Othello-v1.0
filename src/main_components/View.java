...
//	public JButton blackForfeit;		///< Used to give BLACK the option of forfeiting a game
	...
	public void createNames(JPanel panel){
		blackName = new JTextField(" Y O U ");
		blackName.setBounds(650, 10, 200, 40);
//		blackName.setBorder(null);
		blackName.setHorizontalAlignment(SwingConstants.CENTER);
		panel.add(blackName);
		whiteName = new JTextField("COMPUTER");
		whiteName.setBounds(650, 240, 200, 40);
//		whiteName.setBorder(null);
	...
	public void createWins(JPanel panel){
		whiteNumWins = new JTextField(" Computer's Total Wins: " + controller.whiteGamesWon);
                whiteNumWins.setBounds(680, 200, 220, 40);
		whiteNumWins.setEditable(false);
		whiteNumWins.setBorder(null);
		panel.add(whiteNumWins);
		blackNumWins = new JTextField(" Player's Total Wins: " + controller.blackGamesWon);
		blackNumWins.setBounds(680, 50, 220, 40);
	...
	public void createNumDisks(JPanel panel){
		whiteNumDisks = new JTextField("Total Number of White Disks: " + board.whitePlayer.score);
		whiteNumDisks.setBounds(660, 180, 220, 20);
		whiteNumDisks.setEditable(false);
		whiteNumDisks.setBorder(null);
		panel.add(whiteNumDisks);
		blackNumDisks = new JTextField("Total Number of Black Disks: " + board.blackPlayer.score);
		blackNumDisks.setBounds(660, 100, 220, 20);
	...
	public void createUndoButton(JPanel panel){
		...
		undoButton.setBounds(630, 130, 100, 40);
	...
	public void createRedoButton(JPanel panel){
		...
		redoButton.setBounds(780, 130, 100, 40);
	...
	public void createNewGameButtons(JPanel panel){
		...
		newGameEasy.setBounds(650, 340, 200, 40); //10, 660, 180, 30);
		panel.add(newGameEasy);
		newGameMedium = new JButton("New Game - MEDIUM");
		newGameMedium.setBounds(650, 400, 200, 40); //210, 660, 180, 30);
		panel.add(newGameMedium);
		newGameHard = new JButton("New Game - HARD");
		newGameHard.setBounds(650, 460, 200, 40); //410, 660, 180, 30);
	 ...
	 * @param panel
	 */
        public void createGameName(JPanel panel){
            gameName = new JTextField(" OTHELLO 1.0 ");
            gameName.setBounds(625, 540, 250, 40);
	...
	public void createDifficultyText(JPanel panel){
		...
		difficultyText.setBounds(695, 300, 200, 40); 
	...
	public void updateNumDisks(){
		whiteNumDisks.setText("Total Number of White Disks: " + board.whitePlayer.score);
		blackNumDisks.setText("Total Number of Black Disks: " + board.blackPlayer.score);
	}
